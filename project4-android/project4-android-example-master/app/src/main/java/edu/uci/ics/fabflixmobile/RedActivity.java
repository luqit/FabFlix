...
public class RedActivity extends ActionBarActivity {
    ...
    public void connectToTomcat(View view) {
        ...
        final StringRequest afterLoginRequest = new StringRequest(Request.Method.GET, "https://ec2-54-153-105-163.us-west-1.compute.amazonaws.com:8443/project2-api-example/api/login",
        ...
        final StringRequest loginRequest = new StringRequest(Request.Method.POST, "https://ec2-54-153-105-163.us-west-1.compute.amazonaws.com:8443/project2-api-example/api/login",
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
