...
public class BlueActivity extends ActionBarActivity {
    ...
    public void connectToTomcat(View view) {
        ...
        final Intent goToIntent = new Intent(this, ListViewActivity.class);
        ...
        final StringRequest loginRequest = new StringRequest(Request.Method.GET, "https://ec2-54-153-105-163.us-west-1.compute.amazonaws.com:8443/project2-api-example/MovieFullTextSearch?fullTextSearch=" + fullTextSearch,
